...
--
-- Host: localhost:3306
-- Generation Time: Aug 27, 2023 at 01:45 PM
...
INSERT INTO `booking` (`bookingNo`, `user_id`, `hotel_id`, `checkInDate`, `checkOutDate`, `totalCost`, `cancelled`, `completed`, `bookingDate`) VALUES
(40, 23, 1, '2023-08-27', '2023-09-02', 102300, 0, 1, '2023-08-27'),
(41, 23, 4, '2023-09-01', '2023-09-05', 42800, 1, 0, '2023-08-27'),
(42, 22, 3, '2023-08-27', '2023-08-31', 36032, 0, 1, '2023-08-27'),
(43, 22, 5, '2023-09-05', '2023-09-09', 61600, 0, 0, '2023-08-27'),
(44, 25, 6, '2023-08-20', '2023-09-08', 330600, 0, 1, '2023-08-27'),
(45, 25, 5, '2023-09-12', '2023-09-15', 46200, 0, 0, '2023-08-27');
...
INSERT INTO `staff` (`staff_id`, `employee_number`, `role`, `fullname`) VALUES
(9, '#E123_1', 'Employee', 'Kim Renolds'),
(12, '#E123_2', 'Manager', 'Claire Bester'),
(13, '#E123_3', 'Admin', 'Brian Bester');
...
(22, 'Ben', 'Ben Swart', '17 Acacia street', '@#BEN123', 'ben@gmail.com', '083-666-1691'),
(23, 'Mia', 'Mia Renolds', '123 Coral Reef', '123#', 'mia@gmail.com', '071-333-4569'),
(24, 'Zoey', 'Zoey Smith', '43 New Road', 'Zoey/56', 'zoey@gmail.com', '012-555-6395'),
(25, 'Christa', 'Christa Visser', '18 Woodhill street', 'Woodhill()23', 'cool@gmail.com', '083-654-9563');
...
--
ALTER TABLE `booking`
  MODIFY `bookingNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
